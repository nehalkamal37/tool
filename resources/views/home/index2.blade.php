...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('home/magnific-popup.css') }}">
  <link rel="stylesheet" href="{{ asset('home/jquery-ui.css') }}">
  <link rel="stylesheet" href="{{ asset('home/owl.carousel.min.css') }}">
  <link rel="stylesheet" href="{{ asset('home/owl.theme.default.min.css') }}">


  <link rel="stylesheet" href="{{ asset('home/aos.css') }}">
...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="owl-carousel owl-single px-0">
      <div class="site-blocks-cover overlay" style="background-image: url('{{ asset('home/images/hero_bg.jpg') }}');">
    ...
    <div class="site-section bg-image overlay" style="background-image: url({{ asset('home/images/hero_bg_2.jpg') }});">
